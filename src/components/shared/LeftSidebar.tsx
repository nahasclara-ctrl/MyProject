      ...
      style={{
        ...
        ...(isActive
          ? {
              ...
              boxShadow: `0 6px 18px rgba(79,159,117,0.25)`,
            }
          : {
    ...
    >
      <span
        style={{
          ...
          borderRadius: "8px",
          flexShrink: 0,
          background: isActive ? "rgba(255,255,255,0.2)" : P[100],
        }}
      >
        <img
          src={icon}
...
const StoryRing = ({ children, active }: { children: React.ReactNode; active: boolean }) => (
  <span
    style={{
      ...
      flexShrink: 0,
      boxShadow: active
        ? `0 0 0 2px ${P[50]}, 0 0 12px rgba(79,159,117,0.35)`
        : "none",
    ...
    <>
      <nav
        style={{
          ...
          boxShadow: "4px 0 28px rgba(79,159,117,0.08)",
      ...
      >
        <div style={{ display: "flex", flexDirection: "column", gap: "0.85rem" }}>
          ...
          <div style={{ height: 1, background: `linear-gradient(90deg, transparent, ${P[200]}, transparent)` }} />
          ...
          <Link
            ...
            style={{
              ...
              borderRadius: "14px",
              textDecoration: "none",
              background: isProfileActive ? P[50] : "transparent",
            }}
          >
            ...
            {!collapsed && (
              <div>
                ...
                <p style={{ margin: 0, fontSize: "0.7rem", color: P[500] }}>
                  @{user.username}
                </p>
              </div>
            )}
              ...
              if (item.kind === "action") {
                return (
                  <li key={item.label}>
                    ...
                    >
                      <NavRow icon={item.icon} label={item.label} collapsed={collapsed} />
                    </button>
                  </li>
                );
              }
      ...
      {showMood && user.id && (
        <div style={{ position: "fixed", inset: 0, zIndex: 9999, display: "flex" }}>
          ...
          />
          <div style={{ width: 400, maxWidth: "100%", background: "#fff" }}>
